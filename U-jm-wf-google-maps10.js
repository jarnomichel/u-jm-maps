...
const nightTheme = [
    ...
    silverTheme = [
        ...
        { featureType: "administrative.locality", elementType: "labels.text.fill", stylers: [{ color: "#008fca" }] },
        { featureType: "administrative.locality", elementType: "geometry.fill", stylers: [{ color: "#bc1522" }] },
        { featureType: "administrative.country", elementType: "geometry.stroke", stylers: [{ color: "#bc1522", weight: "2" }] },
    ...
    document.querySelectorAll("[udesly-google-map]").forEach((a) => {
        ...
        r.forEach((a) => {
            ...
            "none" != q &&
                ...
                b.addListener(marker, 'mouseout', function(){
                    b.close(s, c);
                 });
        });
    });
